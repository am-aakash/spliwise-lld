...
public class GroupPaymentGraphTest {
    ...
    private ExpenseService constructExpenseService() {
        ...
        expenseService.addExpense(new Expense(null, firstExpense,
        ...
        expenseService.addExpense(new Expense(null, secondExpense,
        ...
        expenseService.addExpense(new Expense(null, thirdExpense,
